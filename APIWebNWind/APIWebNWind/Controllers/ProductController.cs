...
namespace APIWebNWind.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        [HttpGet]
        [Route("ObtenerProductos/{year}")]
        public IEnumerable<object> ObtenerProductos(int year)
        {
        ...
        [HttpGet]
        [Route("Ventas/{productName}/{startDateStr}/{endDateStr}")]
        public IEnumerable<object> Ventas(string productName, string startDateStr, string endDateStr)
        {
        ...
        [HttpGet]
        [Route("Rango/{startDate}/{endDate}")]
        public IEnumerable<object> Rango(string startDate, string endDate)
        {
